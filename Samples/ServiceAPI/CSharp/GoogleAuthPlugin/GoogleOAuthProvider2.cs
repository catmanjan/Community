...
{
    public class GoogleOAuth2ProviderMe : OAuth2Provider
    {
        ...
        public GoogleOAuth2ProviderMe(IAppSettings appSettings)
        ...
        {
            return true;
//            return JsonObject.Parse(VerifyAccessTokenUrl.Fmt(accessToken).GetJsonFromUrl())["issued_to"] == base.ConsumerKey;
        }
